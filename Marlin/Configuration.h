...
#define STRING_CONFIG_H_AUTHOR "(Nils)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 Pro - SKR 2"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "506ed487-827d-4fb5-ae5d-ca2d7ba0ac1c"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  27.35,  27.35 }
    #define DEFAULT_Ki_LIST {   2.50,   2.50 }
    #define DEFAULT_Kd_LIST { 74.94, 74.94 }
  #else
